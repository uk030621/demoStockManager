...
export default function Home() {
    ...
    return (
        <div style={{ textAlign: 'center', marginTop: '15px' }}>
            ...
            <Link className='usstock-link' style={{margin:'top', marginRight:'25px'}} href='/backtointro'>Intro</Link> 
            ...
            <Link className='usstock-link' style={{margin:'top', marginRight:'25px'}} href="https://crypto-tracker-app-phi-fawn.vercel.app/" replace>Crypto</Link>
            </div>
